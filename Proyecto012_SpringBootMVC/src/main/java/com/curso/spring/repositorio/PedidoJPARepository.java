...
@Repository
public interface PedidoJPARepository  extends JpaRepository<Pedido, Integer>{//entidad y prinaryley

	public static Logger log = LoggerFactory.getLogger(PedidoJPARepository.class);
	
	@Query("select p from Pedido p where p.user=?1")//?1 primer argumento
